 ...
 */
@Repository
public interface RaidersDao extends IMybatisDao<Raiders, Long> {

	List<Raiders> listPage(@Param("raiders") Raiders raiders, @Param("pagination") Pagination pagination);
}
