var PullUpController = {
    ing:0,
    show: function(){
        setDisplayBlock('b_gd');
    },
    loading: function(str){
        $('#b_gd_text').html(str || '加载中...')  ;
        //$("#b_gd_img").toggleClass("aa");
         setDisplayBlock('b_gd_img');
       // setTimeOut("PullUpController.loaded();",400) ;
         
    },
    loaded: function(str) {
        $('#b_gd_text').html(str || '显示更多...');
        setDisplayNone('b_gd_img');
    },
    hide:function(){
        setDisplayNone('b_gd');
    }
